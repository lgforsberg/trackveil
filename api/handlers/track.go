...
import (
	...
	"github.com/lgforsberg/trackveil/api/models"
...
func (h *TrackHandler) getOrCreateVisitor(siteID uuid.UUID, fingerprintHash string) (uuid.UUID, error) {
...
func (h *TrackHandler) getOrCreateSession(siteID, visitorID uuid.UUID) (uuid.UUID, error) {
